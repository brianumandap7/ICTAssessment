...
def act(request):
    ...
    return render(request, 'survey/act.html', query)
...
class ICTTrainings(LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['eight'] = 'Information System Planning is the strategic process of aligning technology resources with organizational goals and objectives.'
